...
const modules = {
    collapseAttributeWhitespace: () => import('./modules/collapseAttributeWhitespace'),
    collapseBooleanAttributes: () => import('./modules/collapseBooleanAttributes'),
    collapseWhitespace: () => import('./modules/collapseWhitespace'),
    custom: () => import('./modules/custom'),
    deduplicateAttributeValues: () => import('./modules/deduplicateAttributeValues'),
    example: () => import('./modules/example'),
    mergeScripts: () => import('./modules/mergeScripts'),
    mergeStyles: () => import('./modules/mergeStyles'),
    minifyConditionalComments: () => import('./modules/minifyConditionalComments'),
    minifyCss: () => import('./modules/minifyCss'),
    minifyJs: () => import('./modules/minifyJs'),
    minifyJson: () => import('./modules/minifyJson'),
    minifySvg: () => import('./modules/minifySvg'),
    minifyUrls: () => import('./modules/minifyUrls'),
    normalizeAttributeValues: () => import('./modules/normalizeAttributeValues'),
    removeAttributeQuotes: () => import('./modules/removeAttributeQuotes'),
    removeComments: () => import('./modules/removeComments'),
    removeEmptyAttributes: () => import('./modules/removeEmptyAttributes'),
    removeOptionalTags: () => import('./modules/removeOptionalTags'),
    removeRedundantAttributes: () => import('./modules/removeRedundantAttributes'),
    removeUnusedCss: () => import('./modules/removeUnusedCss'),
    sortAttributes: () => import('./modules/sortAttributes'),
    sortAttributesWithLists: () => import('./modules/sortAttributesWithLists'),
};
