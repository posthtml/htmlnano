...
describe('sortAttributes', () => {
    ...
    it('frequency', () => {
        return init(
            ...
            '<input class="form-control" id="testId" type="text" name="testInput" autocomplete="off"><a class="testClass" id="testId" href="#"></a><img class="cls" id="id2" width="20" src="../images/image.png" height="40" alt="image">',
            {
