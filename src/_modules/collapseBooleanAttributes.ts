...
const missingValueDefaultEmptyStringAttributes: Record<string, Record<string, string>> = {
...
export interface CollapseBooleanAttributesOptions {
    amphtml: boolean;
}

const mod: HtmlnanoModule<CollapseBooleanAttributesOptions> = {
